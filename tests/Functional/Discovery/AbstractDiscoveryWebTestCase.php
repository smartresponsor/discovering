...
abstract class AbstractDiscoveryWebTestCase extends WebTestCase
{
    ...
    private function resetDiscoveryStorage(): void
    {
        ...
        foreach (['discovering.test.sqlite', 'discovering-feedback.test.sqlite', 'discovery-operation.test.json', 'discovery-rebuild-evidence.test.json', 'libsource-operator-event-log.test.json', 'discovery-rate-limit.test.json'] as $filename) {
