...
final class DiscoveryEndpointSecuritySubscriber implements EventSubscriberInterface
{
    ...
    public function onKernelRequest(RequestEvent $event): void
    {
        ...
        if ($this->surfacePolicy->isProtectedManagementPath($path) && !$this->hasExpectedToken($request, 'X-Discovery-Management-Token', $this->managementToken)) {
        ...
        if ($this->surfacePolicy->isProtectedMutationPath($request, $path)) {
        ...
        if ($this->surfacePolicy->isProtectedApiWritePath($request, $path) && !$this->hasExpectedToken($request, 'X-Discovery-Api-Write-Token', $this->apiWriteToken)) {
            $event->setResponse($this->jsonResponseFactory->error(
