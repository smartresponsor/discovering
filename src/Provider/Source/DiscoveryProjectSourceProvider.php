 ...
 */
final class DiscoveryProjectSourceProvider implements DiscoverySourceProviderInterface
{
    public function __construct(
        private readonly DiscoveryProjectSourceRecordRepository $repository,
    ) {
    }
