 ...
 */
final class DiscoveryDocumentSourceProvider implements DiscoverySourceProviderInterface
{
    public function __construct(
        private readonly DiscoveryDocumentSourceRecordRepository $repository,
    ) {
    }
