 ...
 */
final class DiscoveryCategorySourceProvider implements DiscoverySourceProviderInterface
{
    public function __construct(
        private readonly DiscoveryCategorySourceRecordRepository $repository,
    ) {
    }
