...
namespace App\Discovering\Repository\Operations;
 ...
 */
final class DiscoveryDoctrineOperationEventLogStore implements DiscoveryOperationEventLogStoreInterface
{
    ...
    public function all(): array
    {
        ...
        return array_map(fn (DiscoveryOperationEventEntity $entity): DiscoveryOperationEventDTO => $this->hydrate($entity), $entities);
    }
    ...
    private function hydrate(DiscoveryOperationEventEntity $entity): DiscoveryOperationEventDTO
    {
        $context = json_decode($entity->getContextJson(), true);

        return new DiscoveryOperationEventDTO(
    ...
    private function eventId(DiscoveryOperationEventDTO $event): string
    {
