...
namespace App\Discovering\Repository\Backend;
 ...
 */
final class DiscoverySqliteFtsBackend implements DiscoveryBackendInterface, DiscoveryStagingCapableBackendInterface
{
