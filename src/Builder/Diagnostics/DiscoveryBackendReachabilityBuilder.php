...
use App\Discovering\DTO\DiscoveryBackendProbeResultDTO;
use App\Discovering\DTO\DiscoveryBackendReachabilityReportDTO;
...
final class DiscoveryBackendReachabilityBuilder
{
     ...
     */
    public function build(): DiscoveryBackendReachabilityReportDTO
    {
        $probes = [
        ...
        return new DiscoveryBackendReachabilityReportDTO(
    ...
    private function discoveryIndexProbe(): DiscoveryBackendProbeResultDTO
    {
        if ('meili' !== strtolower(trim($this->indexBackend))) {
            return new DiscoveryBackendProbeResultDTO(
    ...
    private function sharedStoreProbe(string $nameEntity, string $backend, string $coordinationConcern): DiscoveryBackendProbeResultDTO
    {
