...
namespace App\Discovering\Builder\Topology;

use App\Discovering\DTO\DiscoveryStateStoreDescriptorDTO;
use App\Discovering\DTO\DiscoveryStateTopologyDTO;
...
final class DiscoveryStateTopologyBuilder
{
     ...
     */
    public function build(): DiscoveryStateTopologyDTO
    {
        ...
        return new DiscoveryStateTopologyDTO(
    ...
    private function discoveryIndexStore(string $localStateRoot): DiscoveryStateStoreDescriptorDTO
    {
        if ('meili' === strtolower(trim($this->indexBackend))) {
            ...
            return new DiscoveryStateStoreDescriptorDTO(
    ...
    private function feedbackStore(): DiscoveryStateStoreDescriptorDTO
    {
        return new DiscoveryStateStoreDescriptorDTO(
    ...
    private function sqliteStore(string $nameEntity, string $path, string $localStateRoot): DiscoveryStateStoreDescriptorDTO
    {
    ...
    ): DiscoveryStateStoreDescriptorDTO {
    ...
    private function jsonStore(string $nameEntity, string $path, string $localStateRoot): DiscoveryStateStoreDescriptorDTO
    {
        $normalizedPath = $this->normalizePath($path);
        $sharedConfigured = !$this->isLocalStatePath($normalizedPath, $localStateRoot);
