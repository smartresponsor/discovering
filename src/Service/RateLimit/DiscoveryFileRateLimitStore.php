 ...
 */
final class DiscoveryFileRateLimitStore implements DiscoveryRateLimitStoreInterface
{
    ...
    private function decodeState(string $contents): array
    {
        ...
        try {
            ...
            throw new \RuntimeException(sprintf('Rate limit store at "%s" contains invalid JSON.', $this->path), previous: $exception);
        }
