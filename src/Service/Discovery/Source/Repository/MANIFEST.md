...
File-backed live sources are also owned here, including JSON import / export tooling and multi-file directory-backed registries for project-local discovery records.
