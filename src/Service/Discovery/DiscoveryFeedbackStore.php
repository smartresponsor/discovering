...
final class DiscoveryFeedbackStore
{
    ...
    private function pdo(): PDO
    {
        ...
        $databasePath = $this->path ?: (getenv('DISCOVERY_FEEDBACK_SQLITE_PATH') ?: sys_get_temp_dir() . '/discovering-feedback.sqlite');
        ...
        $pdo->exec('CREATE TABLE IF NOT EXISTS discovery_feedback (resource TEXT NOT NULL, hit_id TEXT NOT NULL, title TEXT NOT NULL DEFAULT "", reference TEXT NOT NULL DEFAULT "", click_count INTEGER NOT NULL DEFAULT 0, last_clicked_at TEXT DEFAULT NULL, PRIMARY KEY(resource, hit_id))');
        $this->pdo = $pdo;
