...
namespace App\Discovering\Service\Indexer;
...
final class DiscoveryIndexer implements DiscoveryIndexerInterface
{
    ...
    public function rebuild(DiscoveryReindexRequestDTO $request): DiscoveryRebuildSummaryDTO
    {
        ...
        return new DiscoveryRebuildSummaryDTO(
    ...
    private function supportsStagedRebuild(string $targetResource, DiscoveryReindexRequestDTO $request): bool
    {
