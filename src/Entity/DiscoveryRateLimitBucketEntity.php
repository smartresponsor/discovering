...
namespace App\Discovering\Entity;

use App\Discovering\Repository\DiscoveryRateLimitBucketRepository;
...
final class DiscoveryRateLimitBucketEntity
{
    ...
    /**
     * Increments the active fixed-window bucket while preserving its canonical reset boundary.
     */
    ...
    /**
     * Starts a fresh fixed-window bucket with the first consumed request already counted.
     */
