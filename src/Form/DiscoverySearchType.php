...
namespace App\Discovering\Form;
...
final class DiscoverySearchType extends AbstractType
{
    ...
    {
        $query = $builder->getData() instanceof DiscoveryQueryDTO
            ? $builder->getData()
            : new DiscoveryQueryDTO();
        ...
        $builder
            ...
            ->add('mode', ChoiceType::class, [
                ...
                'data' => $query->mode,
                'choices' => [
                    'Relevance' => DiscoveryModeDTO::RELEVANCE,
                    'Governance' => DiscoveryModeDTO::GOVERNANCE,
                    'Operations' => DiscoveryModeDTO::OPERATIONS,
                    'Exploration' => DiscoveryModeDTO::EXPLORATION,
                ],
            ])
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => DiscoveryQueryDTO::class,
            'method' => 'GET',
     ...
     */
    private function weightOptions(DiscoveryQueryDTO $query, string $resource, string $label): array
    {
